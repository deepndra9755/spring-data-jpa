...
public class IServiceImpl implements IService {
   ...
   MyMongoRepo obj;
	@Override
	public DTOimpl GetForm(DTOimpl dd) {
...
//			ssd.add(dt);
//		}
		FormRegisterTest hs=new FormRegisterTest();
		BeanUtils.copyProperties(dd, hs);
		
       FormRegisterTest sd=obj.save(hs);
       DTOimpl sss=new DTOimpl();
       BeanUtils.copyProperties(sd, sss);
		return sss;
